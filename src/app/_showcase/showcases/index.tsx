...
import { Carousel } from "@/components/showcase/showcase-carousel";
import type { ShowcaseItemData } from "@/components/showcase/showcases/showcase-item";
...
const data = [
  {
    ...
    href: "/_showcase/showcases/super-app-paywall",
    components: [
      { name: "BottomSheet", href: "/_showcase/components/bottom-sheet" },
      { name: "Tabs", href: "/_showcase/components/tabs" },
      { name: "FormField", href: "/_showcase/components/form-field" },
      { name: "Button", href: "/_showcase/components/button" },
      { name: "Chip", href: "/_showcase/components/chip" },
    ],
  },
  {
    imageLight:
    ...
    href: "/_showcase/showcases/raycast",
    components: [
      { name: "Select", href: "/_showcase/components/select" },
      { name: "Button", href: "/_showcase/components/button" },
      { name: "Avatar", href: "/_showcase/components/avatar" },
    ],
  },
  {
    imageLight:
    ...
    href: "/_showcase/showcases/cooking-onboarding",
    components: [
      { name: "Popover", href: "/_showcase/components/popover" },
      { name: "Avatar", href: "/_showcase/components/avatar" },
      { name: "Button", href: "/_showcase/components/button" },
      { name: "Divider", href: "/_showcase/components/divider" },
    ],
  },
  {
    imageLight:
    ...
    href: "/_showcase/showcases/linear-task",
    components: [
      { name: "Dialog", href: "/_showcase/components/dialog" },
      { name: "Card", href: "/_showcase/components/card" },
      { name: "Chip", href: "/_showcase/components/chip" },
      { name: "RadioGroup", href: "/_showcase/components/radio-group" },
      { name: "FormField", href: "/_showcase/components/form-field" },
      { name: "Checkbox", href: "/_showcase/components/checkbox" },
      { name: "Button", href: "/_showcase/components/button" },
      { name: "Avatar", href: "/_showcase/components/avatar" },
    ],
  },
  {
    ...
    href: "/_showcase/showcases/paywall",
    components: [
      { name: "Switch", href: "/_showcase/components/switch" },
      { name: "FormField", href: "/_showcase/components/form-field" },
      { name: "RadioGroup", href: "/_showcase/components/radio-group" },
      { name: "Button", href: "/_showcase/components/button" },
    ],
  },
  {
    ...
    href: "/_showcase/showcases/onboarding",
    components: [
      { name: "Button", href: "/_showcase/components/button" },
      { name: "Card", href: "/_showcase/components/card" },
      { name: "Divider", href: "/_showcase/components/divider" },
