...
import { BottomSheetBlurOverlay } from "@/components/ui/bottom-sheet-blur-overlay";
import { BasicBottomSheetContent } from "@/components/ui/bottom-sheet/basic";
import { ScrollableWithSnapPointsContent } from "@/components/ui/bottom-sheet/scrollable-with-snap-points";
import { WithTextInputContent } from "@/components/ui/bottom-sheet/with-text-input";
  ...
  return (
    <View className="flex-1">
      <View className="flex-1 items-center justify-center">
        <Button
          variant="secondary"
          onPress={() => router.push("./bottom-sheet-native-modal")}
        >
