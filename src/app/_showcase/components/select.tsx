...
import { PlacementSelect } from "@/components/ui/select/placement-select";
import { SearchableDialogSelect } from "@/components/ui/select/searchable-dialog-select";
...
const NativeModalTestContent = () => {
  ...
  return (
    <View className="flex-1 px-5 items-center justify-center">
      <Button
        variant="secondary"
        onPress={() => router.push("./select-native-modal")}
      >
