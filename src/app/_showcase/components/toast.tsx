...
import { AchievementToast } from "@/components/showcase/toast/achievement-toast";
import { LoadingToast, useLoadingState } from "@/components/showcase/toast/loading-toast";
import { ProgressToast, useProgressState } from "@/components/showcase/toast/progress-toast";
          ...
          toast.show({
            ...
            icon: (
              <StyledOcticons
                name="shield-check"
                size={16}
                className="text-success mt-0.75"
              />
            ),
            actionLabel: "Close",
            onActionPress: ({ hide }) => hide(),
          ...
          toast.show({
            ...
            icon: (
              <StyledOcticons
                name="shield"
                size={16}
                className="text-warning mt-0.75"
              />
            ),
            actionLabel: "Close",
            onActionPress: ({ hide }) => hide(),
