...
import { Avatar, Chip, Dialog, Label, Radio, RadioGroup } from "heroui-native";
  ...
  const items: AssigneeItem[] = useMemo(
    () => [
      ...
      },
      {
        ...
        label: "Junior",
        indicator: (
          <Avatar alt="junior" className="size-4.5 bg-sky-500">
            <Avatar.Image
              source={{
      ...
      },
      {
        ...
        label: "volo",
        indicator: (
          <Avatar alt="volo" className="size-4.5 bg-purple-500">
            <Avatar.Image
              source={{
